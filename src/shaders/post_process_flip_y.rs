...
pub struct PostProcessFlipYPlugin;
...
impl Plugin for PostProcessFlipYPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_plugins((
            ...
            ExtractComponentPlugin::<PostProcessFlipY>::default(),
        ));
        ...
        render_app
            ...
            .add_render_graph_node::<ViewNodeRunner<PostProcessFlipYNode>>(
                // Specify the name of the graph, in this case we want the graph for 3d
                core_3d::graph::NAME,
                // It also needs the name of the node
                PostProcessFlipYNode::NAME,
            )
    ...
    fn finish(&self, app: &mut App) {
        ...
        render_app
            ...
            .init_resource::<PostProcessFlipYPipeline>();
    }
}
...
impl ViewNode for PostProcessFlipYNode {
    ...
    fn run(
        ...
        let post_process_pipeline = world.resource::<PostProcessFlipYPipeline>();
...
#[derive(Resource)]
struct PostProcessFlipYPipeline {
    layout: BindGroupLayout,
    sampler: Sampler,
    pipeline_id: CachedRenderPipelineId,
}

impl FromWorld for PostProcessFlipYPipeline {
